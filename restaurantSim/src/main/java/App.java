...
//        BufferedReader file = new BufferedReader(new FileReader("C:\\Users\\bilgi-999\\IdeaProjects\\thread-safety\\my_multi_threading\\restaurantSim\\src\\main\\resources\\data1.txt"));
        BufferedReader file = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/restaurantSim/src/main/resources/data1.txt"));
